...
from PyQt5.Qt import QImage, QPixmap, QPainter, QPoint, QPaintEvent, QMouseEvent, QPen, \
    QColor, QSize
...
class PaintBoard(QWidget):
    ...
    def __InitData(self):
        ...
        self.__size = QSize(260, 260)

        # 新建QPixmap作为画板，尺寸为__size
        self.__board = QPixmap(self.__size)
        self.__board.fill(Qt.transparent)  # 用白色填充画板
